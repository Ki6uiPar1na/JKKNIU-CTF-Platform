const CATEGORY_CFG = {
  ...
  steganography: { name: 'Steganography', icon: 'fa-image', color: 'orange' },
  blockchain: { name: 'Blockchain', icon: 'fa-piggy-bank', color: 'teal' },
  misc: { name: 'Misc', icon: 'fa-dice-five', color: 'violet' },
  ppc: { name: 'Programming', icon: 'fa-chart-line', color: 'plum' },
  osint: { name: 'OSINT', icon: 'fa-eye', color: 'gray' },
  koth: { name: 'King of the Hill', icon: 'fa-crown', color: 'plum' },
...
export function categoryScheme(cat) {
  return CATEGORY_SCHEMES[categoryConfig(cat).color] || CATEGORY_SCHEMES.gray;
}
